...
func (x *ClientInfo) GetId() *Identity {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *ClientInfo) GetPeer() *PeerInfo {
	if x != nil {
		return x.Peer
	}
	return nil
...
func (x *ClientInfo) GetBrokers() []*BrokerInfo {
	if x != nil {
		return x.Brokers
	}
	return nil
...
func (x *ClientInfo) GetProviders() []*ProviderInfo {
	if x != nil {
		return x.Providers
	}
	return nil
...
var file_monolith_types_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0xbe, 0x01, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e,
...
var file_monolith_types_proto_goTypes = []interface{}{
	...
	(*ClientInfo)(nil),          // 12: monolith.ClientInfo
}
var file_monolith_types_proto_depIdxs = []int32{
	...
	6,  // 15: monolith.ClientInfo.id:type_name -> monolith.Identity
	8,  // 16: monolith.ClientInfo.peer:type_name -> monolith.PeerInfo
	9,  // 17: monolith.ClientInfo.brokers:type_name -> monolith.BrokerInfo
	11, // 18: monolith.ClientInfo.providers:type_name -> monolith.ProviderInfo
