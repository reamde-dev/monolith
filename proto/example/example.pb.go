...
import (
	...
	_ "reamde.dev/monolith/proto/monolith"
	reflect "reflect"
	sync "sync"
)
...
func (x *TypeA) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TypeA) ProtoMessage() {}

func (x *TypeA) ProtoReflect() protoreflect.Message {
	mi := &file_example_example_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TypeA.ProtoReflect.Descriptor instead.
func (*TypeA) Descriptor() ([]byte, []int) {
	return file_example_example_proto_rawDescGZIP(), []int{2}
}

func (x *TypeA) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *TypeB) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TypeB) ProtoMessage() {}

func (x *TypeB) ProtoReflect() protoreflect.Message {
	mi := &file_example_example_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TypeB.ProtoReflect.Descriptor instead.
func (*TypeB) Descriptor() ([]byte, []int) {
	return file_example_example_proto_rawDescGZIP(), []int{3}
}

func (x *TypeB) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_example_example_proto_rawDesc = []byte{
	...
	0x1a, 0x14, 0x6d, 0x6f, 0x6e, 0x6f, 0x6c, 0x69, 0x74, 0x68, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73,
	...
	,
...
var file_example_example_proto_goTypes = []interface{}{
	...
	(*TypeA)(nil),        // 2: example.TypeA
	(*TypeB)(nil),        // 3: example.TypeB
}
var file_example_example_proto_depIdxs = []int32{
	0, // 0: example.PingService.Ping:input_type -> example.PingRequest
	1, // 1: example.PingService.Ping:output_type -> example.PingResponse
